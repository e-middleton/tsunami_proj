...
#------------------------------
    ...
    clawdata.lower[0] = params.lower[0]
    clawdata.upper[0] = params.upper[0]

    clawdata.lower[1] = params.lower[1]
    clawdata.upper[1] = params.upper[1]



    # Number of grid cells: Coarsest grid = 2 degree resolution
    ...
    if clawdata.output_style==1:
        ...
        clawdata.num_output_times = params.num_output_times # every 10 minute for the first 4 hours
        clawdata.tfinal = endtime
...
#-------------------
    ...
    # == Forcing Options
    geo_data.coriolis_forcing = False # docs said this was usually fine to not use for tsunami simulations

    # == Algorithm and Initial Conditions ==
    geo_data.sea_level = 0.0
    geo_data.dry_tolerance = 1.e-3
    geo_data.friction_forcing = True
    geo_data.manning_coefficient =.025 # value for most tsunami simulation
    geo_data.friction_depth = 1e6 # originally 1e6
    ...
    # == settopo.data values ==
    rundata.topo_data.topo_missing = -32767 # added because test_topo file has missing values
    ...
    rundata.fgmax_data.num_fgmax_val = params.num_fgmax_val # save only depth 
    rundata.fgmax_data.fgmax_grids = params.fgmax_grids  # empty list to start
    rundata.regiondata.regions = params.regions
    rundata.flagregiondata.flagregions = params.flagregions
