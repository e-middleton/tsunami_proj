...
os.path.join(scratch_dir, 'urakawa1982/RuledRectangle_fgmax.txt')
...
fg.point_style = 4
fg.xy_fname = os.path.join(scratch_dir, 'urakawa1982/fgmax_pts_topostyle.txt')  # file of 0/1 values in tt3 format
